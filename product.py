...
class productClass:
    def __init__(self,root):
        ...
        cmb_search.place(x=10,y=10,width=180)       #Category,Supplier,Name
        ...
        self.product_table=ttk.Treeview(p_frame,columns=("P_Id","Supplier","Category","Name","Price","Qty","Status"),yscrollcommand=scrolly.set,xscrollcommand=scrollx.set)
