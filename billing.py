...
class BillClass:
    def __init__(self,root):
        ...
        pTitle = Label(ProductFrame1, text = "All Services", font = ("goudy old style", 20, "bold"), bg = "#262626", fg = "white").pack(side=TOP, fill=X)
        ...
        lbl_search = Label(ProductFrame2, text = "Search Service | By Name", font = ("times new roman",15,"bold"), bg = "white", fg = "green").place(x=2,y=5)

        lbl_search = Label(ProductFrame2, text = "Service name", font = ("times new roman",15,"bold"), bg = "white").place(x=2,y=45)
        ...
        self.product_Table.heading("pid", text="SID")
        ...
        self.cartTitle=Label(cart_Frame,text="Cart \t Total Product: [0]",font=("goudy old style",13),bg="lightgray")
        ...
        billFrame.place(x=953,y=110,width=323,height=410)
        ...
        billMenuFrame.place(x=953,y=520,width=323,height=140)

        self.lbl_amnt=Label(billMenuFrame,text="Bill Amount\n[0]",font=("goudy old style",13,"bold"),bg="#3f51b5",fg="white")
        self.lbl_amnt.place(x=2,y=5,width=105,height=70)

        self.lbl_discount=Label(billMenuFrame,text="Discount \n[5%]",font=("goudy old style",13,"bold"),bg="#8bc34a",fg="white")
        self.lbl_discount.place(x=109,y=5,width=105,height=70)

        self.lbl_net_pay=Label(billMenuFrame,text="Net Pay\n[0]",font=("goudy old style",13,"bold"),bg="#607d8b",fg="white")
        self.lbl_net_pay.place(x=216,y=5,width=105,height=70)


        btn_print=Button(billMenuFrame,text="Print",command = self.print_bill,cursor="hand2",font=("goudy old style",13,"bold"),bg="lightgreen",fg="white")
        ...
        btn_clear_all.place(x=109,y=80,width=105,height=50)
        ...
        btn_generate.place(x=216,y=80,width=105,height=50)
...
#====================================================================================================================================
    ...
    def search(self):
        ...
        try:
            if self.var_search.get() == "":
                ...
                cur.execute("SELECT P_Id,name,price,qty,status FROM product WHERE name LIKE '%"+self.var_search.get()+"%' and status='Active'")
                rows = cur.fetchall()
                if len(rows) != 0:
                    self.product_Table.delete(*self.product_Table.get_children())
                    for row in rows:
    ...
    def bill_top(self):
        ...
        bill_top_temp =f'''
\t     BLOOD LINKS
Phone No. 9567125482 , Mumbai-400056
{str("="*37)}
...
{str("="*37)}
        '''
        self.txt_bill_area.insert('1.0',END)
...
{str("="*37)}\n
    ...
    def print_bill(self):
        if self.chk_print == 1:
            messagebox.showinfo('Print','Please wait, printing.', parent = self.root)
