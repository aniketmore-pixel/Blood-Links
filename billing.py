...
class BillClass:
    def __init__(self,root):
        ...
        cartTitle=Label(cart_Frame,text="Cart \t Total Product: [0]",font=("goudy old style",13),bg="lightgray").pack(side=TOP,fill=X)
        ...
        billMenuFrame.place(x=953,y=110,width=410,height=410)

        self.lbl_amnt=Label(billMenuFrame,text="Bill Amount\n[0]",font=("goudy old style",12,"bold"),bg="#3f51b5",fg="white")
        self.lbl_amnt.place(x=2,y=5,width=102,height=70)

        self.lbl_discount=Label(billMenuFrame,text="Discount \n[5%]",font=("goudy old style",12,"bold"),bg="#8bc34a",fg="white")
        self.lbl_discount.place(x=106,y=5,width=102,height=70)

        self.lbl_net_pay=Label(billMenuFrame,text="Net Pay\n[0]",font=("goudy old style",12,"bold"),bg="#607d8b",fg="white")
        self.lbl_net_pay.place(x=210,y=5,width=102,height=70)

        btn_print=Button(billMenuFrame,text="Print",cursor="hand2",font=("goudy old style",12,"bold"),bg="lightgreen",fg="white")
        btn_print.place(x=2,y=80,width=102,height=50)

        btn_clear_all=Button(billMenuFrame,text="Clear All",cursor="hand2",font=("goudy old style",12,"bold"),bg="gray",fg="white")
        btn_clear_all.place(x=106,y=80,width=102,height=50)

        btn_generate=Button(billMenuFrame,text="Generate Bill",cursor="hand2",font=("goudy old style",12,"bold"),bg="#009688",fg="white")
        btn_generate.place(x=210,y=80,width=102,height=50)
